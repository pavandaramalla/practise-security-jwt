...
import com.security.practisesecurityjwt.filter.TokenAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity security) throws Exception {
        ...
        return security.csrf().disable()
                .authorizeHttpRequests().requestMatchers("/customer", "/login").permitAll()
                .and()
                .authorizeHttpRequests().requestMatchers("/demo/**").authenticated()
                .and()
